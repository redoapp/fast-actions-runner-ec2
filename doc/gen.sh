...
cp "$(rlocation redotech_fast_actions_runner_ec2/doc/basic_templates.md)" "$BUILD_WORKSPACE_DIRECTORY"/doc/basic-cf-templates.md
cp "$(rlocation redotech_fast_actions_runner_ec2/doc/provisioner.md)" "$BUILD_WORKSPACE_DIRECTORY"/doc/provisioner.md
cp "$(rlocation redotech_fast_actions_runner_ec2/doc/templates.md)" "$BUILD_WORKSPACE_DIRECTORY"/doc/cf-templates.md
